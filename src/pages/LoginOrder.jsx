...
const LoginOrder = () => {
 ...
 if (redirectTo) {
  ...
  return (
    <React.Fragment>
      <Wrapper>
        ...
        <div className="md:ml-[80px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-12 items-center mb-20  justify-center">
          ...
          <div className="col-span-4 mt-16 ">
            ...
            >
              ...
              <p className="mt-4 text-[#212121] text-sm">
               ...
               <Link to="/terms-condition"><span className="font-semibold hover:text-green-500">Terms & Condition</span></Link>  and{" "}
               <Link to="/privacy-policy"><span className="font-semibold hover:text-green-500">Privacy Policy</span></Link> 
              </p>

              <p className="mt-4 text-sm ">
                Don’t have an account?{" "}
                <Link to="/sign-up" className="text-primary font-semibold hover:text-green-500">
  ...
  <button
                type="submit"
                className="flex items-center justify-center w-full bg-primary text-white px-3 py-4 font-semibold text-base rounded-[4px]"
...
export default React.memo(LoginOrder);
